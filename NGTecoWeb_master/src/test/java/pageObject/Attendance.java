...
public class Attendance<WebElements> {
    ...
    private org.openqa.selenium.WebElement Attendance_Module;
    ...
    private java.util.List<WebElement> To_Display_All_records;
    ...
    private java.util.List<WebElement> ExportListRecord;
    ...
    private java.util.List<WebElement> TimeCardRefreshBtn;

    @FindBy(xpath = "//div[contains(@class, 'MuiDataGrid-row') and contains(@class, 'MuiDataGrid-row--lastVisible')]")
    private java.util.List<WebElement> ScrollUntilllastElement;
    ...
    private java.util.List<WebElement> AllheadersAvailableonEditTS;
...
//    private WebElement EndDatePicker;
    ...
    public java.util.List<WebElement> getView_Attendance_All_Headers() {
        return View_Attendance_All_Headers;
    }

    public java.util.List<WebElement> getView_Page_Records() {
    ...
    public java.util.List<WebElement> getTo_Display_All_records() {
    ...
    public java.util.List<WebElement> getExportListRecord() {
        return ExportListRecord;
    }

    public java.util.List<WebElement> getTimeCardRefreshBtn() {
        return TimeCardRefreshBtn;
    }

    public java.util.List<WebElement> getScrollUntilllastElement() {
    ...
    public java.util.List<WebElement> getAllheadersAvailableonEditTS(){
...
//        }
    ...
    public static void ValidateTheAllTheComponentsInsideViewAttendancePunch(WebDriver driver, Attendance attendance) {
        ...
        java.util.List<WebElement> HeaderList = attendance.getView_Attendance_All_Headers();
        System.out.println("Available Headers:");
        for (WebElement headers : HeaderList) {
            System.out.println(headers.getText() + "\t");
        }
        java.util.List<WebElement> listrecords = attendance.getView_Page_Records();
    ...
    public static void MendPunch_Enable_code(WebDriver driver, Attendance attendance) {
        ...
        java.util.List<WebElement> redTextRecords = attendance.getView_Page_Records();
...
// Click previous page until it's not clickable anymore
    ...
    public static void userShouldListTheRecordsBySelecting(WebDriver driver,Attendance attendance) throws Exception {
        ...
        resetZoomToDefault();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        java.util.List<WebElement> recordsPerPageOptions = Arrays.asList(
                attendance.getTen_records_per_page(),
                attendance.getTwenty_records_per_page(),
                attendance.getFiFTY_records_per_page()
        );
        java.util.List<String> optionLabels = Arrays.asList("10", "20", "50");
        for (int i = 0; i < recordsPerPageOptions.size(); i++) {
            ...
            java.util.List<WebElement> scrollContainers = attendance.getScrollUntilllastElement();
    ...
    public static void userCanRefreshThePageAndRecordsShouldGetListedProperly(WebDriver driver,Attendance attendance) throws InterruptedException {
        ...
        java.util.List<WebElement> paginationBefore = attendance.getTimeCardRefreshBtn();
